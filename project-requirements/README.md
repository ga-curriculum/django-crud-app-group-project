...
For this project, you and your team will build a Django application with full CRUD. Your team gets to decide what to build as long as it meets the technical requirements outlined below.
