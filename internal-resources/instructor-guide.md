...
- Django CRUD App Group Project Journey
- Django CRUD App Group Project Requirements
- Django CRUD App Group Project Individual Contributor Requirements
- Django CRUD App Group Project Details
- Django CRUD App Group Project Deliverables (students submit links to project planning materials, a front-end and back-end GitHub repo, and a deployed app throughout project week)
- Django CRUD App Group Project Feedback [in Canvas only]
- Django CRUD App Group Project Individual Contributor Feedback [in Canvas only]
...
While all these pages can be edited, you'll likely want to make the most edits on the Django CRUD App Group Project Details page. Some sensible defaults are provided here, but you may want to customize some aspects of this document to match how you'd like to structure your project week for your students.
...
Some instructors may want to split the project deliverable into multiple parts so that each item be given its own due date. Individual deliverable pages exist in this content and do not need to be created. These can be found at:
...
- [Project Requirements Google Sheets](https://docs.google.com/spreadsheets/d/1cDGq-KNn12P-h6rcAf-FeTldBMIyduV_mDrK3DUh_j4/edit).
...
- All Django CRUD App Group Project rubrics in Canvas.
